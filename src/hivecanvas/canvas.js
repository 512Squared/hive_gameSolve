            ...
            if ( // play button was pressed
                ...
                if (oneStep === true) {
                    ...
                    if (tenStarWizards === true) {
                        document.getElementById('hits').innerHTML = "</br>Sorry to disappoint, but there are ZERO solutions to this game board. Not a single one! Nada. No eureka moment - no rainbows and unicorns. Just top-level head scratching!</br></br>I did suspect as much during the HIVE test. Now, after coding this in Javascript/Canvas (I was a novice coder before this!) and testing every single permutation, I'm confident there is no solution.</br></br>This particular game board was probably chosen by Hive Helsinki to keep testers occupied at the end of the entrance test, until the 2 hours were up. Or maybe my solve algorithm has a flaw &#128522;.</br></br>But feel free to sit back and watch the 25 permutations that came closest. Many follow the same route, but a few take a different route.</br></br>All hail the 10-star Wizards!";
                    }
