        ...
        canvas.addEventListener('click', function (playButton) {
            ...
            if ( // play button was pressed
                ...
                if (oneStep === true) {
                    ...
                    if (everyPerm === true) {
                        document.getElementById('hits').innerHTML = "</br>Okay! You are clever. You've unlocked the permutation solver. </br></br>If you have ~1 year, you can watch all 537,824 permutations<sup>†</sup> being tested at x1 speed</br></br>Every permutation is given 70 cycles to find a solution, allowing the Solve Engine to break out of any loops.</br></br>If you click x3 speed, you will engage a solve algorithm that catches the obvious fails and reduces the time for testing down to ~17 hours &#128522;.</br></br>Pause will reveal the number of permutations already completed.</br></br>If the permutation tester finds a solution, it will stop testing and announce the winning permutation!</br></br>All hail the Solve Wizard!</br></br>† Equation for calculating the number of permutations: </br>(x<sub>1</sub>+x<sub>2</sub>+...+x<sub>n</sub>=k)";
                    }
